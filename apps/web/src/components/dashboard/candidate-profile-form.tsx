...
interface Props {
  /** Called after successful save so parent can refresh stats. */
  onSaved?: () => void;
}

export function CandidateProfileForm({ onSaved }: Props) {
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            These fields cannot be changed here. Contact support for corrections.
          </CardDescription>
        </CardHeader>
        <CardContent>
